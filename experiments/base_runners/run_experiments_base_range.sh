...
rm test.db
python3 data_processor.py $num_tables $num_queries $num_repetitions "Min/max" $dir/raw_data_min_max.csv "Min/max clusters (10x)" $dir/raw_data_cluster_10.csv "Min/max clusters (100x)" $dir/raw_data_cluster_100.csv "Min/max clusters (1000x)" $dir/raw_data_cluster_1000.csv
rm test.db
